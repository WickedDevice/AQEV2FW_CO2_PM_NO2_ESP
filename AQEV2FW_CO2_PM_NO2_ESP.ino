...
void initializeHardware(void) {
    ...
    Serial.println(F(" |    NO2 / CO2 / PM Sensor Suite     |"));
...
void restore(char * arg) {
    ...
    if (strncmp(arg, "defaults", 8) == 0) {
        ...
        eeprom_write_block("aqev2_co2_pm_no2_esp", (void *) EEPROM_UPDATE_FILENAME, 32);
    }
...
boolean publishHeartbeat() {
    ...
    snprintf(scratch, SCRATCH_BUFFER_SIZE-1,
             ...
             "\"converted-value\":%d,"
             "\"firmware-version\":\"%s\","
             "\"publishes\":[\"co2\",\"particulate\",\"no2\",\"temperature\",\"humidity\"%s],"
             "\"counter\":%lu"
